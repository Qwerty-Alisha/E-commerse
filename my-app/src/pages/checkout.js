...
function Checkout() {
  ...
  // New State to toggle Stripe Modal
  ...
  const handleOrder = () => {
    if (selectedAddress !== null && paymentMethod) {
      const order = {
        ...
        user: user.id,
        paymentMethod,
        selectedAddress: user.addresses[selectedAddress],
        status: 'pending',
      };
      ...
      if (paymentMethod === 'cash') {
        ...
        // ✅ Card: Open Stripe modal, wait for payment success
  ...
  // This function is passed to StripeCheckout. It runs ONLY after payment succeeds.
  const handlePaymentSuccess = () => {
    const order = {
      ...
      user: user.id,
      paymentMethod: 'card',
      paymentStatus: 'received', // You can add this field to your schema
      selectedAddress: user.addresses[selectedAddress],
      status: 'pending',
    };
    dispatch(createOrderAsync(order));
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-12 bg-white max-w-7xl px-2 sm:px-2 lg:px-4">
              ...
              <div className="border-t border-gray-200 px-2 py-6 sm:px-2">
                ...
                {/* ✅ STRIPE MODAL: This renders only when Card is selected and Order Now clicked */}
                {openStripeModal && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
                    <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
                      ...
                      <StripeCheckout
                        ...
                        handleOrderSuccess={handlePaymentSuccess}
                      />
                      <button
