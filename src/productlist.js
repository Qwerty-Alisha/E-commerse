...
import {fetchAllProductsAsync, fetchAsync, fetchProductbyFiltersAsync} from './productSlice.js'
import {
  Dialog,
  DialogBackdrop,
  DialogPanel,
...
import { StarIcon, ChevronDownIcon, FunnelIcon, MinusIcon, PlusIcon, Squares2X2Icon } from '@heroicons/react/20/solid'
                            ...
                            <div className="flex h-5 shrink-0 items-center">
                              <div className="group grid size-4 grid-cols-1">
                                <input
                                  ...
                                  name={`${section.id}[]`}
                                  type="checkbox"
                                  className="col-start-1 row-start-1 appearance-none rounded border border-gray-300 bg-white checked:border-indigo-600 checked:bg-indigo-600 indeterminate:border-indigo-600 indeterminate:bg-indigo-600 focus-visible:outline onCdisabled:checked:bg-gray-100 forced-colors:appearance-auto"
                                  onChange= {e=>handleFilter(e, section, option)}
                                />
                                <svg
                                  fill="none"
